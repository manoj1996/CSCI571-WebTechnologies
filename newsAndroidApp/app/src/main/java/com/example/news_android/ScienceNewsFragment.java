...
public class ScienceNewsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.news_science_fragment, container, false);
        ...
        homeListView = (RecyclerView) view.findViewById(R.id.news_science_list);
    ...
    private void setScienceNews(){
        homeListView.setVisibility(View.GONE);
        String url = "https://news-api-hw9.azurewebsites.net/guardian/news?section=science";
