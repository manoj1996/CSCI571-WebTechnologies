...
public class SportsNewsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.news_sports_fragment, container, false);
        ...
        homeListView = (RecyclerView) view.findViewById(R.id.news_sports_list);
    ...
    private void setSportsNews(){
        String url = "https://news-api-hw9.azurewebsites.net/guardian/news?section=sport";
