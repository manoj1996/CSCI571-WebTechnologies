...
public class PoliticsNewsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.news_politics_fragment, container, false);
        ...
        homeListView = (RecyclerView) view.findViewById(R.id.news_politics_list);
    ...
    private void setPoliticsNews(){
        homeListView.setVisibility(View.GONE);
        String url = "https://news-api-hw9.azurewebsites.net/guardian/news?section=politics";
