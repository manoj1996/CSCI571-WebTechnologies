...
public class BusinessNewsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.news_business_fragment, container, false);
        ...
        homeListView = (RecyclerView) view.findViewById(R.id.news_business_list);
    ...
    private void setBusinessNews(){
        homeListView.setVisibility(View.GONE);
        String url = "https://news-api-hw9.azurewebsites.net/guardian/news?section=business";
