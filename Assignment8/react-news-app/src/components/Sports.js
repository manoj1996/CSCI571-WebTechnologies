...
class Sports extends Component 
{
    ...
    callGuardian()
    {
        fetch("https://news-api.azurewebsites.net/guardian/news?section=sport").then(res=> {
        return res.json();
            }).then(news_articles=> this.setState({articles:news_articles}));
    }
    callNyt()
    {
        fetch("https://news-api.azurewebsites.net/nyTimes/news?section=sports").then(res=> {
            return res.json();
