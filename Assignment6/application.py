...
def newsAPI():
    ...
    try:
        ...
        for headline in topHeadlines['articles']:
            if 'source' in headline and headline['source']['name'] \
                    and 'author' in headline and headline['author'] \
                    and 'description' in headline and headline['description'] \
                    and 'title' in headline and headline['title'] \
                    and 'url' in headline and headline['url'] \
                    and 'urlToImage' in headline and headline['urlToImage'] \
                    and 'publishedAt' in headline and headline['publishedAt']:
    ...
    #---------------------------------------------------------------------------------------------------------
        ...
        for headline in HeadLines:
            for word in headline.split(" "):
                word1 = word.lower()
                if word != '' and word not in string.punctuation and word1 not in stopWords:
